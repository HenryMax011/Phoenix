...
/** Círculo com arco de luz vermelha percorrendo a borda */
export function StarCircle({
  children,
  size = 88,
  lightWidth = 52,
  duration = 2.4,
  ...
  return (
    <div
      className={cn(
        "relative z-[3] inline-flex items-center justify-center overflow-visible rounded-full",
        className,
      )}
      style={
        {
    ...
    >
      {/* Fundo + partículas */}
      <div
        className="pointer-events-none absolute inset-0 z-[1] overflow-hidden rounded-full border-white bg-black text-white"
        style={{ borderWidth: "var(--border-width)" }}
        aria-hidden
      >
        <StarBackground color={backgroundColor} />
      ...
      {/* Anel vermelho completo na circunferência */}
      <svg
